...
async def with_async_retry(func: Callable[..., Any], *args, max_retries: int = 3, base_delay: float = 2.0, **kwargs):
    """
    ...
    while retries <= max_retries:
        try:
            ...
            logger.warning(f"Attempt {retries + 1} failed for {func.__name__}: {e}. Retrying in {delay}s...")
